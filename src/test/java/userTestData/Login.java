...
public class Login {
    ...
    // Define the criteria for the job to create your person specification BasePage data
    ...
    // Enter Name of Qualification BasePage data
    public static String NAME_OF_QUALIFICATION = "Doctor";
    // Enter Name of Registration BasePage data
    ...
    // Safeguard Questions BasePage data
